defmodule BaconNet.Modules.Ddr.Playerdata2 do
  ...
  def routes do
    %{
      ...
      tag: "local2",
      handlers: [
        {"playerdata_2", "usergamedata_advanced", :playerdata_2_usergamedata_advanced},
        {"playerdata_2", "usergamedata_recv", :playerdata_2_usergamedata_recv},
        {"playerdata_2", "usergamedata_send", :playerdata_2_usergamedata_send}
      ]
    }
  end
  ...
  def playerdata_2_usergamedata_advanced(conn) do
    ...
    response =
      cond do
        ...
        mode == "userload" and refid != default ->
          {all_scores, mcode_order} =
            if all_profiles_for_card != nil do
              collect_scores(Map.fetch!(all_profiles_for_card, "ddr_id"))
            else
              {%{}, []}
            end
          ...
          profile =
            if all_profiles_for_card != nil do
              get_game_profile(refid, game_version)
            else
              # Python: profile stays unbound here and the response build dies
              # with NameError at E.opt_timing_disp(...)
              raise "name 'profile' is not defined"
            end
          ...
          event_nodes =
            for event <- 100..2//-1, event not in [4, 6, 7, 8, 14, 47, 90] do
              E.e("eventdata", [
          ...
          E.e(
            ...
            E.e(
              ...
              [
                ...
                E.e("eventdata_count_all", 0, __type: "s16"),
                E.e("opt_timing_disp", Map.get(profile, "opt_timing_disp", -1), __type: "s32")
              ] ++
                music_nodes ++
                event_nodes ++
                [
                  E.e("grade", [
                    E.e("single_grade", Map.get(profile, "single_grade", 0), __type: "u32"),
                    E.e("double_grade", Map.get(profile, "double_grade", 0), __type: "u32")
                  ]),
                  E.e("pre_playable", E.e("pre_playable_id", "0", __type: "str"))
                ]
            )
          )
        ...
        mode == "userload" and refid == default ->
          E.e(
            ...
            E.e("playerdata_2", [
              E.e("result", 0, __type: "s32"),
              E.e("is_new", 1, __type: "bool"),
              E.e("is_refid_locked", 0, __type: "bool"),
              E.e("eventdata_count_all", 0, __type: "s16"),
              E.e("opt_timing_disp", -1, __type: "s32")
            ])
          )
        ...
        mode == "rivalload" ->
          ...
          E.e(
            ...
            E.e("playerdata_2", [
              E.e("result", 0, __type: "s32"),
              E.e("data", for(s <- load, do: E.e("record", E.e("record_csv", s, __type: "str"))))
            ])
          )
        ...
        true ->
          E.e("response", E.e("playerdata_2", E.e("result", 1, __type: "s32")))
      end

    Core.send_response(conn, info, response)
  end

  def playerdata_2_usergamedata_recv(conn) do
    {info, conn} = Core.process_request(conn)
    game_version = info.game_version
  ...
  def playerdata_2_usergamedata_send(conn) do
    ...
    response = E.e("response", E.e("playerdata_2", E.e("result", 0, __type: "s32")))
