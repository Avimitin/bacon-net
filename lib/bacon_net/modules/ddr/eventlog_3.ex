defmodule BaconNet.Modules.Ddr.Eventlog3 do
  @moduledoc "Port of modules/ddr/eventlog_3.py."
  ...
  def routes do
    %{
      prefix: "/local2",
      tag: "local2",
      handlers: [{"eventlog_3", "write", :ddr_eventlog_3_write}]
    }
  end

  def ddr_eventlog_3_write(conn) do
