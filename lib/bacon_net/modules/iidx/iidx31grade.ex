defmodule BaconNet.Modules.Iidx.Iidx31grade do
  @moduledoc "Port of modules/iidx/iidx31grade.py."
  ...
  def routes do
    %{
      ...
      tag: "local2",
      handlers: [
        {"IIDX31grade", "raised", :iidx31grade_raised}
      ]
    }
  end
  ...
  def iidx31grade_raised(conn) do
    ...
    Core.send_response(conn, info, E.e("response", E.e("IIDX31grade", pnum: 1)))
  end
end
