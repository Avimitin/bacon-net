defmodule BaconNet.Modules.Iidx.Iidx29pc do
  ...
  def routes do
    %{
      ...
      tag: "local2",
      handlers: [
        {"IIDX29pc", "get", :iidx29pc_get},
        {"IIDX29pc", "common", :iidx29pc_common},
        {"IIDX29pc", "save", :iidx29pc_save},
        {"IIDX29pc", "visit", :iidx29pc_visit},
        {"IIDX29pc", "reg", :iidx29pc_reg},
        {"IIDX29pc", "getLaneGachaTicket", :iidx29pc_getlanegachaticket},
        {"IIDX29pc", "drawLaneGacha", :iidx29pc_drawlanegacha},
        {"IIDX29pc", "eaappliresult", :iidx29pc_eaappliresult},
        {"IIDX29pc", "logout", :iidx29pc_logout}
      ]
    }
  end
    ...
    response =
      E.e("response",
        E.e("IIDX29pc", [
          ...
          E.e("nostalgia_open"),
          E.e("event_1",
            story_prog: Map.get(profile, "event_1_story_prog", 0),
            last_select_area: Map.get(profile, "event_1_last_select_area", 0),
            failed_num: Map.get(profile, "event_1_failed_num", 0),
            event_play_num: Map.get(profile, "event_1_event_play_num", 0),
            last_select_area_id: Map.get(profile, "event_1_last_select_area_id", 0),
            last_select_platform_type: Map.get(profile, "event_1_last_select_platform_type", 0),
            last_select_platform_id: Map.get(profile, "event_1_last_select_platform_id", 0)
          ),
          E.e("language_setting", language: profile["language_setting"]),
          E.e("movie_agreement", agreement_version: profile["movie_agreement"]),
          E.e("bpl_virtual"),
          ...
          E.e("ultimate_mobile_link", music_list: -1),
          E.e("bemani_musiq_fes", music_list: -1),
          E.e("busou_linkage", music_list: -1),
          E.e("busou_linkage_2", music_list: -1),
          E.e("valkyrie_linkage_data", progress: -1),
          E.e("valkyrie_linkage_2_data", progress: -1),
          E.e(
            "achievements",
            E.e("trophy", Map.get(profile, "achievements_trophy", []) |> Enum.take(20),
              __type: "s64"
            ),
      ...
      E.e("response",
        E.e(
          ...
          [
            ...
            E.e("movie_upload", url: Config.ip()),
  ...
  def iidx29pc_save(conn) do
    ...
    response = E.e("response", E.e("IIDX29pc", iidxid: xid, cltype: clt))

    Core.send_response(conn, info, response)
  end

  def iidx29pc_visit(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx29pc_reg(conn) do
    ...
    response = E.e("response", E.e("IIDX29pc", id: card, id_str: card_split))

    Core.send_response(conn, info, response)
  end

  def iidx29pc_getlanegachaticket(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx29pc_drawlanegacha(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx29pc_eaappliresult(conn) do
    {info, conn} = Core.process_request(conn)

    response = E.e("response", E.e("IIDX29pc"))

    Core.send_response(conn, info, response)
  end

  def iidx29pc_logout(conn) do
    {info, conn} = Core.process_request(conn)
