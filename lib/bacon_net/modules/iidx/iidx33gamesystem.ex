defmodule BaconNet.Modules.Iidx.Iidx33gamesystem do
  @moduledoc "Port of modules/iidx/iidx33gamesystem.py."
  ...
  def routes do
    %{
      ...
      tag: "local",
      handlers: [
        {"IIDX33gameSystem", "systemInfo", :iidx33gamesystem_systeminfo}
      ]
    }
  end
  ...
  def iidx33gamesystem_systeminfo(conn) do
    ...
    children =
      (for mid <- unlock do
        ...
        [
          ...
          E.e("OldBPLBattleOpenPhase", val: 1),
          E.e("BPLBattleOpenPhase", val: 3),
          E.e("VocaloidEvent", val: 1)
          # E.e("beat", val: 5293),
        ]

    response = E.e("response", E.e("IIDX33gameSystem", children))
