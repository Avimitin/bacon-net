defmodule BaconNet.Modules.Iidx.Iidx32pc do
  @moduledoc "Port of modules/iidx/iidx32pc.py."
  ...
  def routes do
    %{
      ...
      tag: "local",
      handlers: [
        {"IIDX32pc", "get", :iidx32pc_get},
        {"IIDX32pc", "common", :iidx32pc_common},
        {"IIDX32pc", "save", :iidx32pc_save},
        {"IIDX32pc", "visit", :iidx32pc_visit},
        {"IIDX32pc", "reg", :iidx32pc_reg},
        {"IIDX32pc", "getLaneGachaTicket", :iidx32pc_getlanegachaticket},
        {"IIDX32pc", "consumeLaneGachaTicket", :iidx32pc_consumelanegachaticket},
        {"IIDX32pc", "drawLaneGacha", :iidx32pc_drawlanegacha},
        {"IIDX32pc", "eaappliresult", :iidx32pc_eaappliresult},
        {"IIDX32pc", "playstart", :iidx32pc_playstart},
        {"IIDX32pc", "playend", :iidx32pc_playend},
        {"IIDX32pc", "delete", :iidx32pc_delete},
        {"IIDX32pc", "logout", :iidx32pc_logout},
        {"IIDX32pc", "getCompeInfo", :iidx32pc_getcompeinfo}
      ]
    }
  end
  ...
  def iidx32pc_get(conn) do
    ...
    response =
      E.e(
        ...
        E.e("IIDX32pc", [
          E.e("pcdata",
            bgnflg: Map.get(profile, "bgnflg", 0),
          ...
          E.e("triple_tribe_4", music_list: -1),
  ...
  def iidx32pc_save(conn) do
    ...
    game_profile =
      Enum.reduce(XNode.children(node, "skin_equip"), game_profile, fn skin_equip, gp ->
    ...
    game_profile =
      Enum.reduce(XNode.children(node, "tdjskin_equip"), game_profile, fn tdjskin_equip, gp ->
    ...
    response = E.e("response", E.e("IIDX32pc", iidxid: xid, cltype: clt))

    Core.send_response(conn, info, response)
  end

  def iidx32pc_visit(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx32pc_reg(conn) do
    ...
    response = E.e("response", E.e("IIDX32pc", id: card, id_str: card_split))

    Core.send_response(conn, info, response)
  end

  def iidx32pc_getlanegachaticket(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx32pc_consumelanegachaticket(conn) do
    {info, conn} = Core.process_request(conn)

    response = E.e("response", E.e("IIDX32pc"))

    Core.send_response(conn, info, response)
  end

  def iidx32pc_drawlanegacha(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx32pc_eaappliresult(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx32pc_playstart(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx32pc_getcompeinfo(conn) do
    {info, conn} = Core.process_request(conn)
