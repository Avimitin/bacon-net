defmodule BaconNet.Modules.Iidx.Iidx31pc do
  @moduledoc "Port of modules/iidx/iidx31pc.py."
  ...
  def routes do
    %{
      ...
      tag: "local2",
      handlers: [
        {"IIDX31pc", "get", :iidx31pc_get},
        {"IIDX31pc", "common", :iidx31pc_common},
        {"IIDX31pc", "save", :iidx31pc_save},
        {"IIDX31pc", "visit", :iidx31pc_visit},
        {"IIDX31pc", "reg", :iidx31pc_reg},
        {"IIDX31pc", "getLaneGachaTicket", :iidx31pc_getlanegachaticket},
        {"IIDX31pc", "consumeLaneGachaTicket", :iidx31pc_consumelanegachaticket},
        {"IIDX31pc", "drawLaneGacha", :iidx31pc_drawlanegacha},
        {"IIDX31pc", "eaappliresult", :iidx31pc_eaappliresult},
        {"IIDX31pc", "playstart", :iidx31pc_playstart},
        {"IIDX31pc", "playend", :iidx31pc_playend},
        {"IIDX31pc", "delete", :iidx31pc_delete},
        {"IIDX31pc", "logout", :iidx31pc_logout},
        {"IIDX31pc", "getCompeInfo", :iidx31pc_getcompeinfo}
      ]
    }
  end
      ...
      E.e(
        ...
        E.e(
          ...
          [
            ...
            E.e("triple_tribe_2", music_list: -1),
            E.e("achievements",
          ...
          qproback: Map.get(profile, "back", 0)
        )
      )
  ...
  def iidx31pc_save(conn) do
    ...
    response = E.e("response", E.e("IIDX31pc", iidxid: xid, cltype: clt))

    Core.send_response(conn, info, response)
  end

  def iidx31pc_visit(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx31pc_reg(conn) do
    ...
    response = E.e("response", E.e("IIDX31pc", id: card, id_str: card_split))

    Core.send_response(conn, info, response)
  end

  def iidx31pc_getlanegachaticket(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx31pc_consumelanegachaticket(conn) do
    {info, conn} = Core.process_request(conn)

    response = E.e("response", E.e("IIDX31pc"))

    Core.send_response(conn, info, response)
  end

  def iidx31pc_drawlanegacha(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx31pc_eaappliresult(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx31pc_playstart(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx31pc_getcompeinfo(conn) do
    {info, conn} = Core.process_request(conn)
