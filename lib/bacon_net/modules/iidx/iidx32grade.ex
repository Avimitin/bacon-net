defmodule BaconNet.Modules.Iidx.Iidx32grade do
  @moduledoc "Port of modules/iidx/iidx32grade.py."
  ...
  def routes do
    %{
      ...
      tag: "local",
      handlers: [
        {"IIDX32grade", "raised", :iidx32grade_raised}
      ]
    }
  end
  ...
  def iidx32grade_raised(conn) do
    ...
    Core.send_response(conn, info, E.e("response", E.e("IIDX32grade", pnum: 1)))
  end
end
