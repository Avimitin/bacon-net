defmodule BaconNet.Modules.Iidx.Iidx33grade do
  @moduledoc "Port of modules/iidx/iidx33grade.py."
  ...
  def routes do
    %{
      ...
      tag: "local",
      handlers: [
        {"IIDX33grade", "raised", :iidx33grade_raised}
      ]
    }
  end
  ...
  def iidx33grade_raised(conn) do
    ...
    Core.send_response(conn, info, E.e("response", E.e("IIDX33grade", pnum: 1)))
  end
end
