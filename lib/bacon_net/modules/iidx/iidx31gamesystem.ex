defmodule BaconNet.Modules.Iidx.Iidx31gamesystem do
  ...
  def routes do
    %{
      ...
      tag: "local2",
      handlers: [
        {"IIDX31gameSystem", "systemInfo", :iidx31gamesystem_systeminfo}
      ]
    }
  end
  ...
  def iidx31gamesystem_systeminfo(conn) do
    ...
    children =
      for mid <- unlock do
        ...
        [
          grade_course(0, 15, [25090, 23068, 19004, 29045]),
          grade_course(0, 16, [23005, 27078, 22065, 27060]),
          grade_course(0, 17, [29007, 26108, 19002, 18004]),
          grade_course(0, 18, [25007, 18032, 16020, 12004]),
          grade_course(1, 15, [15032, 29033, 27092, 30020]),
          grade_course(1, 16, [10028, 26070, 28091, 23075]),
          grade_course(1, 17, [26012, 28002, 17017, 28005]),
          grade_course(1, 18, [28008, 15001, 19002, 9028]),
          E.e("arena_schedule", [
        ...
        [
          ...
          E.e("Event1Value", val: 0),
          E.e("Event2Phase", val: 0),
          ...
          E.e("UnlockLeggendaria", val: 1),
          E.e("Event1AllPlayerTotalGetMetron", val: 0)
        ]

    response = E.e("response", E.e("IIDX31gameSystem", children))
