defmodule BaconNet.Modules.Iidx.Iidx29music do
  @moduledoc "Port of modules/iidx/iidx29music.py."
  ...
  def routes do
    %{
      ...
      tag: "local2",
      handlers: [
        {"IIDX29music", "getrank", :iidx29music_getrank},
        {"IIDX29music", "crate", :iidx29music_crate},
        {"IIDX29music", "reg", :iidx29music_reg},
        {"IIDX29music", "appoint", :iidx29music_appoint}
      ]
    }
  end

  def iidx29music_getrank(conn) do
    ...
    response =
      E.e(
        "response",
        E.e("IIDX29music", [E.e("style", type: play_style)] ++ m_nodes ++ top_nodes)
      )

    Core.send_response(conn, info, response)
  end

  def iidx29music_crate(conn) do
    {info, conn} = Core.process_request(conn)
    game_version = info.game_version
    ...
    response = E.e("response", E.e("IIDX29music", c_nodes))
    Core.send_response(conn, info, response)
  end

  def iidx29music_reg(conn) do
    {info, conn} = Core.process_request(conn)
    game_version = info.game_version
  ...
  def iidx29music_appoint(conn) do
    {info, conn} = Core.process_request(conn)
    node = Core.module_node(info)
    ...
    response = E.e("response", E.e("IIDX29music", vals))
    Core.send_response(conn, info, response)
  end
