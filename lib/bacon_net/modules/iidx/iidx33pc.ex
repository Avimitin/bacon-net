defmodule BaconNet.Modules.Iidx.Iidx33pc do
  ...
  def routes do
    %{
      ...
      handlers: [
        ...
        {"IIDX33pc", "common", :iidx33pc_common},
        {"IIDX33pc", "save", :iidx33pc_save},
        {"IIDX33pc", "visit", :iidx33pc_visit},
        {"IIDX33pc", "reg", :iidx33pc_reg},
        {"IIDX33pc", "getLaneGachaTicket", :iidx33pc_getlanegachaticket},
        {"IIDX33pc", "consumeLaneGachaTicket", :iidx33pc_consumelanegachaticket},
        {"IIDX33pc", "drawLaneGacha", :iidx33pc_drawlanegacha},
        {"IIDX33pc", "eaappliresult", :iidx33pc_eaappliresult},
        {"IIDX33pc", "playstart", :iidx33pc_playstart},
        {"IIDX33pc", "playend", :iidx33pc_playend},
        {"IIDX33pc", "delete", :iidx33pc_delete},
        {"IIDX33pc", "logout", :iidx33pc_logout},
        {"IIDX33pc", "getCompeInfo", :iidx33pc_getcompeinfo}
      ]
    }
  end
  ...
  def iidx33pc_get(conn) do
    ...
    date_code = String.to_integer(info.ext)
    ...
    rivals =
      ...
      |> Enum.map(fn {r, idx} ->
        ...
        %{
          ...
          back: Map.get(rival_profile, "back", 0),
      ...
      E.e("response",
        E.e("IIDX33pc", [
          E.e("pcdata",
            ...
            category: Map.get(profile, "category", 0),
            ...
            d_laneobj_brignt: Map.get(profile, "s_laneobj_brignt", 0),
            ...
            idstr: djid_split,
            mode: profile["mode"],
            movie_thumbnail: Map.get(profile, "movie_thumbnail", 0),
            name: profile["djname"],
            naviflg: Map.get(profile, "naviflg", 0),
            ...
            s_laneobj_brignt: Map.get(profile, "s_laneobj_brignt", 0),
          ...
          E.e(
            ...
            brightness_bg: Map.get(profile, "lightning_setting_brightness_bg", 0),
            brightness_concentration:
              Map.get(profile, "lightning_setting_brightness_concentration", 0),
            assistant_disp_type: Map.get(profile, "lightning_setting_assistant_disp_type", 0),
            assistant_last_tab: Map.get(profile, "lightning_setting_assistant_last_tab", 0),
            assistant_chara: Map.get(profile, "lightning_setting_assistant_chara", 0)
          ),
          E.e(
            "arena_data",
            [
              ...
              E.e(
                "setting",
                E.e("hide_shopname", 0, __type: "bool"),
                stats_type: 0
              ),
              E.e("qpro_motion",
                motion_0: 1,
          ...
          E.e("secret", [
            ...
            E.e("flg5", Map.get(profile, "secret_flg5", [-1, -1, -1]), __type: "s64")
          ]),
          E.e("leggendaria", [
            E.e("flg1", Map.get(profile, "leggendaria_flg1", [-1, -1, -1]), __type: "s64"),
            E.e("flg2", Map.get(profile, "leggendaria_flg2", [-1, -1, -1]), __type: "s64")
          ]),
          E.e(
            "music_memo",
            for fi <- 0..9, ps <- 0..1 do
              E.e(
                "folder",
                E.e(
                  "music_id",
                  Map.get(profile, "music_memo_#{fi}_#{ps}_mids", List.duplicate(0, 10)),
                  __type: "s32"
                ),
                play_style: ps,
                folder_id: fi,
                name:
                  Map.get(
                    profile,
                    "music_memo_#{fi}_#{ps}_name",
                    "FOLDER " <> String.pad_leading(to_string(fi + 1), 2, "0")
                  )
              )
            end
          ),
          ...
          E.e(
            ...
            [
              ...
              profile["sudden"],
              profile["grapharea"],
              Map.get(profile, "lift", 0),
              profile["keybeam"],
              Map.get(profile, "keybeam_size", 1),
              profile["fullcombo"],
              Map.get(profile, "pskin_id_19", 0),
              Map.get(profile, "pskin_id_20", 0),
              Map.get(profile, "pskin_id_21", 0)
            ],
            __type: skin_type
          ),
          E.e(
            "vskin",
            [
              Map.get(profile, "submonitor", 0),
              Map.get(profile, "subbg", 0),
              Map.get(profile, "vskin_id_2", 0),
              Map.get(profile, "vskin_id_3", 0)
            ],
            __type: "s32"
          ),
          E.e(
            ...
            [
              ...
              profile["hand"],
              profile["body"],
              Map.get(profile, "back", 0)
            ],
            __type: "u32",
            __size: 6 * 4
          ),
          E.e("rlist", rival_nodes),
          E.e("rlist_sub", rival_nodes),
          E.e(
            "notes_radar",
          ...
          E.e(
            ...
            dp_level_exh: Map.get(profile, "stepup_dp_level_exh", 0),
            dp_level_h: Map.get(profile, "stepup_dp_level_h", 0),
            ...
            sp_level_exh: Map.get(profile, "stepup_sp_level_exh", 0),
            sp_level_h: Map.get(profile, "stepup_sp_level_h", 0),
          ...
          E.e("deller", deller: profile["deller"]),
          E.e("orb_data",
            rest_orb: 100,
            present_orb: 100
          ),
          ...
          E.e("triple_tribe_3", music_list: -1),
          E.e("reflecbeat_event", music_list: -1),
          E.e("beatstream_event", music_list: -1),
  ...
  def iidx33pc_common(conn) do
    {info, conn} = Core.process_request(conn)
    game_version = info.game_version
    client_host = conn.remote_ip |> :inet.ntoa() |> to_string()

    all_score_stats =
      Enum.filter(DB.all("iidx_score_stats"), fn d ->
        d["music_id"] < (game_version + 1) * 1000
      end)

    hits =
      all_score_stats
      |> Enum.sort_by(fn d -> d["play_count"] end, :desc)
      |> Enum.take(10)
    ...
    hitcharts =
      for k <- 0..1, p <- 0..2 do
        E.e(
          ...
          # 0=national, 1=facility
          kind: k,
          # 0=all, 1=monthly, 2=weekly
          period: p
        )
      end
      ...
      E.e("response",
        E.e(
          ...
          [
            ...
            E.e("ir", beat: 3),
            E.e("cm", compo: "cm_bpl", folder: "cm", id: 0),
  ...
  def iidx33pc_save(conn) do
        ...
        lightning_setting ->
          gp =
            Enum.reduce(
              ...
              game_profile,
              fn k, acc ->
                case XNode.attr(lightning_setting, k) do
                  nil -> acc
                  v -> Map.put(acc, "lightning_setting_" <> k, String.to_integer(v))
                end
              end
            )
    ...
    game_profile =
      case XNode.child(node, "music_memo") do
        nil ->
          game_profile

        music_memo ->
          Enum.reduce(XNode.children(music_memo, "folder"), game_profile, fn f, gp ->
            fi = XNode.attr(f, "folder_id")
            fn_name = XNode.attr(f, "name")
            ps = XNode.attr(f, "play_style")
            mids = f |> XNode.child("music_id") |> XNode.text_ints()

            gp
            |> Map.put("music_memo_#{fi}_#{ps}_name", fn_name)
            |> Map.put("music_memo_#{fi}_#{ps}_mids", mids)
          end)
      end
        ...
        step ->
          gp =
            Enum.reduce(
              ...
              game_profile,
              fn k, acc ->
                case XNode.attr(step, k) do
                  nil -> acc
                  v -> Map.put(acc, "stepup_" <> k, String.to_integer(v))
                end
              end
            )
    ...
    game_profile =
      Enum.reduce(XNode.children(node, "pskin_equip"), game_profile, fn skin_equip, gp ->
        skin_id = XNode.attr(skin_equip, "skin_id") |> String.to_integer()

        case Map.fetch(skin, skin_id) do
          {:ok, field} ->
            Map.put(gp, field, XNode.attr(skin_equip, "skin_no") |> String.to_integer())
    ...
    game_profile =
      Enum.reduce(XNode.children(node, "vskin_equip"), game_profile, fn tdjskin_equip, gp ->
        skin_id = XNode.attr(tdjskin_equip, "skin_id") |> String.to_integer()

        case Map.fetch(tdjskin, skin_id) do
          {:ok, field} ->
            Map.put(gp, field, XNode.attr(tdjskin_equip, "skin_no") |> String.to_integer())
    ...
    response = E.e("response", E.e("IIDX33pc", iidxid: xid, cltype: clt))

    Core.send_response(conn, info, response)
  end

  def iidx33pc_visit(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx33pc_reg(conn) do
    ...
    version_profile = %{
      ...
      "lightning_setting_brightness_bg" => 0,
      "lightning_setting_brightness_concentration" => 0,
      "lightning_setting_assistant_disp_type" => 0,
      "lightning_setting_assistant_last_tab" => 0,
      "lightning_setting_assistant_chara" => 0,
    ...
    response = E.e("response", E.e("IIDX33pc", id: card, id_str: card_split))

    Core.send_response(conn, info, response)
  end

  def iidx33pc_getlanegachaticket(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx33pc_consumelanegachaticket(conn) do
    {info, conn} = Core.process_request(conn)

    response = E.e("response", E.e("IIDX33pc"))

    Core.send_response(conn, info, response)
  end

  def iidx33pc_drawlanegacha(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx33pc_eaappliresult(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx33pc_playstart(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx33pc_getcompeinfo(conn) do
    {info, conn} = Core.process_request(conn)
