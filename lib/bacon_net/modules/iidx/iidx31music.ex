defmodule BaconNet.Modules.Iidx.Iidx31music do
  @moduledoc "Port of modules/iidx/iidx31music.py."
  ...
  def routes do
    %{
      ...
      tag: "local2",
      handlers: [
        {"IIDX31music", "getrank", :iidx31music_getrank},
        {"IIDX31music", "crate", :iidx31music_crate},
        {"IIDX31music", "reg", :iidx31music_reg},
        {"IIDX31music", "appoint", :iidx31music_appoint},
        {"IIDX31music", "arenaCPU", :iidx31music_arenacpu},
        {"IIDX31music", "retry", :iidx31music_retry},
        {"IIDX31music", "play", :iidx31music_play},
        {"IIDX31music", "nosave", :iidx31music_nosave},
        {"IIDX31music", "movieinfo", :iidx31music_movieinfo}
      ]
    }
  end

  def iidx31music_getrank(conn) do
    ...
    response =
      E.e(
        "response",
        E.e("IIDX31music", [E.e("style", type: play_style)] ++ m_nodes ++ top_nodes)
      )

    Core.send_response(conn, info, response)
  end

  def iidx31music_crate(conn) do
    {info, conn} = Core.process_request(conn)
    game_version = info.game_version
    ...
    response = E.e("response", E.e("IIDX31music", c_nodes))
    Core.send_response(conn, info, response)
  end

  def iidx31music_reg(conn) do
    {info, conn} = Core.process_request(conn)
    game_version = info.game_version
  ...
  def iidx31music_appoint(conn) do
    {info, conn} = Core.process_request(conn)
    node = Core.module_node(info)
    ...
    response = E.e("response", E.e("IIDX31music", vals))
    Core.send_response(conn, info, response)
  end

  def iidx31music_arenacpu(conn) do
    {info, conn} = Core.process_request(conn)
    node = Core.module_node(info)
  ...
  def iidx31music_retry(conn) do
    {info, conn} = Core.process_request(conn)

    response =
      E.e(
        "response",
        E.e("IIDX31music", [E.e("session", session_id: 1)], status: 0)
      )

    Core.send_response(conn, info, response)
  end

  def iidx31music_play(conn) do
    {info, conn} = Core.process_request(conn)

    response = E.e("response", E.e("IIDX31music"))

    Core.send_response(conn, info, response)
  end

  def iidx31music_nosave(conn) do
    {info, conn} = Core.process_request(conn)
  ...
  def iidx31music_movieinfo(conn) do
    {info, conn} = Core.process_request(conn)

    response =
      E.e(
        "response",
        E.e("IIDX31music", status: 0)
      )
