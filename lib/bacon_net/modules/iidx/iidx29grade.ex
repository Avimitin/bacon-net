defmodule BaconNet.Modules.Iidx.Iidx29grade do
  @moduledoc "Port of modules/iidx/iidx29grade.py."
  ...
  def routes do
    %{
      ...
      tag: "local2",
      handlers: [
        {"IIDX29grade", "raised", :iidx29grade_raised}
      ]
    }
  end
  ...
  def iidx29grade_raised(conn) do
    ...
    grade_sp =
      DB.search("iidx_class_best", %{"iidx_id" => iidx_id, "gtype" => 0, "cstage" => 4})
    ...
    grade_dp =
      DB.search("iidx_class_best", %{"iidx_id" => iidx_id, "gtype" => 1, "cstage" => 4})
    ...
    Core.send_response(conn, info, E.e("response", E.e("IIDX29grade", pnum: 1)))
  end
end
