{application,hex,
             [{modules,['Elixir.Hex','Elixir.Hex.API.Auth',
                        ...
                        'Elixir.Hex.HTTP.SSL',
                        'Elixir.Hex.HTTP.VerifyHostname','Elixir.Hex.Ignores',
                        'Elixir.Hex.Mix','Elixir.Hex.Mix.TaskDescription',
                        'Elixir.Hex.Netrc','Elixir.Hex.Netrc.Cache',
                        'Elixir.Hex.Netrc.Parser','Elixir.Hex.OAuth',
                        'Elixir.Hex.Package','Elixir.Hex.Parallel',
                        'Elixir.Hex.Policy','Elixir.Hex.Policy.Diagnostics',
