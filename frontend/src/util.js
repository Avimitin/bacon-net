...
const ERROR_MESSAGES = {
  ...
  field_not_editable: "That field cannot be edited — only PIN and per-version settings are writable.",
  invalid_pin: "PIN must be exactly 4 digits.",
  invalid_version: "Per-version settings must be version number → settings maps of simple values.",
  csrf_header_required: "The request was rejected by the CSRF guard — reload and try again.",
  invalid_limit: "Invalid page size.",
  invalid_cursor: "Invalid page cursor.",
  missing_parameters: "Pick a game, song, and chart first.",
