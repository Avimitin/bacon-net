...
{:ok, {{_, st, _}, _, _}} =
  :httpc.request(
    :post,
    {~c"http://127.0.0.1:8000/manage/api/shops", permit_headers, ~c"application/json",
     permit_body},
    [],
    []
  )
...
if st == 409 do
  {:ok, {{_, st2, _}, _, _}} =
    :httpc.request(
      :post,
      {~c"http://127.0.0.1:8000/manage/api/shops/A00000000000/permit", permit_headers,
       ~c"application/json", ~s|{}|},
      [],
      []
    )
...
{st, doc} =
  Smoke.post_kbin(
    "/core/LDJ:J:A:A:2025091700/services/get",
    "LDJ:J:A:A:2025091700",
    E.e("services", method: "get")
  )
...
Smoke.check(
  "has game services",
  Enum.all?(["local", "local2", "lobby", "lobby2"], &(&1 in items))
)
...
{st, doc} =
  Smoke.post_kbin(
    "/local/LDJ:J:A:A:2025091700/IIDX33pc/common",
    "LDJ:J:A:A:2025091700",
...
{st, doc} =
  Smoke.post_kbin(
    "/local/LDJ:J:A:A:2025091700/IIDX33pc/reg",
    "LDJ:J:A:A:2025091700",
    E.e("IIDX33pc", method: "reg", cid: card, name: "ＴＥＳＴ", pid: "13")
  )
...
{st, doc} =
  Smoke.post_kbin(
    "/local/LDJ:J:A:A:2025091700/IIDX33pc/get",
    "LDJ:J:A:A:2025091700",
    E.e("IIDX33pc", method: "get", cid: card)
  )
...
{st, doc} =
  Smoke.post_kbin(
    "/local/LDJ:J:A:A:2025091700/IIDX33shop/getname",
    "LDJ:J:A:A:2025091700",
    E.e("IIDX33shop", method: "getname")
  )
...
{st, doc} =
  Smoke.post_kbin(
    "/local/LDJ:J:A:A:2025091700/IIDX33music/getrank",
    "LDJ:J:A:A:2025091700",
    E.e("IIDX33music", method: "getrank", cltype: "0")
  )
...
{st, doc} =
  Smoke.post_kbin(
    "/local/LDJ:J:A:A:2025091700/IIDX33gameSystem/systemInfo",
    "LDJ:J:A:A:2025091700",
    E.e("IIDX33gameSystem", method: "systemInfo")
  )
...
{st, _doc} =
  Smoke.post_kbin(
    "/local2/LDJ:J:A:A:2021101300/IIDX29pc/common",
    "LDJ:J:A:A:2021101300",
    E.e("IIDX29pc", method: "common")
  )
...
{st, doc} =
  Smoke.post_kbin(
    "/local2/KFC:J:A:A:2020090402/game/sv6_new",
    "KFC:J:A:A:2020090402",
    E.e("game", [E.e("dataid", card), E.e("cardno", "1"), E.e("name", "TEST")], method: "sv6_new")
  )
...
{st, doc} =
  Smoke.post_kbin(
    "/local2/KFC:J:A:A:2020090402/game/sv6_load",
    "KFC:J:A:A:2020090402",
    E.e("game", [E.e("dataid", card)], method: "sv6_load")
  )
...
body =
  Kbinxml.encode(
    E.e("call", E.e("game", [E.e("dataid", card)], method: "sv6_load"),
...
{:ok, {{_, st, _}, _, resp}} =
  :httpc.request(
    :post,
    {~c"http://127.0.0.1:8000/fwdr?model=KFC:J:A:A:2020090402&f=game.sv6_load", [],
     ~c"application/octet-stream", body},
    [],
    body_format: :binary
  )
...
{st, doc} =
  Smoke.post_kbin(
    "/local2/MDX:J:A:A:2019022600/system/convcardnumber",
    "MDX:J:A:A:2019022600",
    E.e("system", [E.e("data", E.e("card_id", card))], method: "convcardnumber")
  )
...
{st, doc} =
  Smoke.post_kbin(
    "/local2/MDX:J:A:A:2019022600/playerdata/usergamedata_recv",
    "MDX:J:A:A:2019022600",
    E.e("playerdata", method: "usergamedata_recv", refid: card)
  )
...
{st, doc} =
  Smoke.post_kbin(
    "/local/M32:J:A:A:2024031300/gf10_shopinfo/regist",
    "M32:J:A:A:2024031300",
    E.e("gf10_shopinfo", method: "regist")
  )
...
body =
  Kbinxml.encode(
    E.e("call", E.e("gf10_shopinfo", method: "regist"),
      model: "M32:J:A:A:2024031300",
      srcid: "A00000000000"
    )
  )
...
{:ok, {{_, st, _}, _, resp}} =
  :httpc.request(
    :post,
    {~c"http://127.0.0.1:8000/fwdr?model=M32:J:A:A:2024031300&f=gf10_shopinfo.regist", [],
     ~c"application/octet-stream", body},
    [],
    body_format: :binary
  )
...
{st, doc} =
  Smoke.post_kbin(
    "/local/REC:J:A:A:2019022600/game/get_common",
    "REC:J:A:A:2019022600",
    E.e("game", method: "get_common")
  )
...
{st, doc} =
  Smoke.post_kbin(
    "/local/PAN:J:A:A:2019022600/op3_common/get_common_info",
    "PAN:J:A:A:2019022600",
    E.e("op3_common", method: "get_common_info")
  )
